...
class ChaptersApiChapter(
     ...
     * and they receive the non-readable [LOCKED_READER_URL] so they can never be
     * opened by accident.
     */
...
/**
 * Non-readable relative placeholder used as the reader URL for locked (paid)
 * chapters so tapping them never opens a reader. The site emits
